...
const dummyCourses = [
    ...
    { id: "mobileapp", title: "Mobile App Development", description: "Create mobile applications for Android and iOS." },
    { id: "cybersecurity", title: "Cyber Security", description: "Understand how to protect systems and data from threats." },
    { id: "dataai", title: "Data Science & AI", description: "Analyze data and build intelligent systems." },
    { id: "clouddevops", title: "Cloud & DevOps", description: "Deploy and manage applications in the cloud." },
